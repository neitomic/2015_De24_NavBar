...
@section('custom-styles')
    ...
    <!--<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800,400italic" id="custom_font">-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group"><span
                                                            class="input-group-addon">Container Color</span><input
                                                            class="form-control color {hash:true}" id="cont-color"
                                                            value="#ffffff" type="text" onchange="updatemenu()"/></div>
                                            </div>
                                            <div class="col-md-4">
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="content-box">
                                                            ...
                                                            <input type="radio" name="background-menu" value="solid"
                                                                   id="solid-back" onchange="updatemenu()"/><label
                                                            ...
                                                            <input type="radio" name="background-menu" value="gradient"
                                                                   ...
                                                                   onchange="updatemenu()"/><label for="gradient-back">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="content-box">
                                                            ...
                                                            <p>
                                                                ...
                                                                <select class="form-control" onchange="updatemenu()"
                                                                        id="border-style">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="content-box">
                                                            ...
                                                            <input type="radio" name="background-sub" value="solid-sub"
                                                                   id="solid-back-sub" onchange="updatemenu()"/><label
                                                            ...
                                                            <input type="radio" name="background-sub"
                                                                   ...
                                                                   checked="checked" onchange="updatemenu()"/><label
...
<pre class="prettyprint lang-css" style="overflow:auto;">
&lt;ul id="menu-bar"&gt;
